...
public class EventConfig {
    ...
    public static final int VE_CLOUD_NO_LOGIN = 30005;
    ...
    public static final int SHARE_DOUYIN_CALLBACK_EVENT_CODE = 20012;
    ...
    public static final int BIPARTITION_APP_INSTALL_EVENT_CODE = 20031;//双开空间应用安装成功
    ...
    public static final int ACTION_GAME_APPOINTMENT_EVENT_CODE = 20060;

    public static final int SHOW_APP_CHANGE_NAME_EVENT_CODE = 20080;

    public static final int ACTION_LOGIN_EVENT_CODE = 20066;


    public static final int SEND_PUT_CHANNEL_ERR = 30001;

    public static final int NIM_CLIENT_NEW_MESSAGE = 30002;

    public static final int FORUM_UPDATE_CODE = 50001;//长评论新增草稿
    public static final int FORUM_PUSH_CODE = 50002;//长评论发布草稿
}
