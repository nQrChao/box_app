...
import com.zqhy.app.core.tool.utilcode.StringUtils;
...
public class IDCardUtils {
     ...
     *
     * @param IDStr            身份证号
     * @param isIncludeUnAdult 是否验证未成年
     * @return true 有效：false 无效
     * @throws ParseException
     */
    public static boolean IDCardValidate(String IDStr, boolean isIncludeUnAdult) {
...
//          errorInfo = "身份证生日无效。";
    ...
    private static boolean isNumeric(String str) {
        Pattern pattern = Pattern.compile(PATTERN_IS_NUMERIC);
    ...
    public static boolean isDate(String strDate) {
        Pattern pattern = Pattern.compile(PATTERN_IS_DATE);
