...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME         = "leeham";
    private static String CALENDARS_ACCOUNT_NAME = "LEEHAM@leeham.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.leeham";
    private static String CALENDARS_DISPLAY_NAME = "LEEHAM账户";
     ...
     * 添加日历事件
     */
    public static boolean addCalendarEvent(Context context, String title, String description, long reminderTime, int previousMinute) {
        if (context == null) {
            return false;
        }
        //获取日历账户的id
     ...
     * @param context
     * @param title            标题
     * @param reminderTime     行程结束时间 精确到ms
     * @param continuousMinute 持续时间，开始时间 = 行程结束时间 - 持续时间，精确到min
     * @param previousMinute   提前开始时间 精确到min
     * @return
     */
    public static boolean addCalendarEvent(Context context, String title, String description, long reminderTime, int continuousMinute, int previousMinute) {
        if (context == null) {
            return false;
        }
        //获取日历账户的id
        ...
        //添加日历事件
        Calendar mCalendar = Calendar.getInstance();
        //设置开始时间，开始时间-previousMinute分钟
        long startTime = reminderTime - (continuousMinute * 60 * 1000);
