...
public class NewProvinceGameItemHolder extends AbsItemHolder<GameInfoVo, NewProvinceGameItemHolder.ViewHolder> {
    public NewProvinceGameItemHolder(Context context) {
        super(context);
    }
