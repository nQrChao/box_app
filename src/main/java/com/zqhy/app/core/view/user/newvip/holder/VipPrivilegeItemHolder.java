...
public class VipPrivilegeItemHolder extends AbsItemHolder<VipPrivilegeVo, VipPrivilegeItemHolder.ViewHolder> {
    public VipPrivilegeItemHolder(Context context) {
        super(context);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull VipPrivilegeVo item) {
