 ...
 */
public class TradeRecordItemHolder extends AbsItemHolder<TradeGoodInfoVo, TradeRecordItemHolder.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull TradeGoodInfoVo item) {
        ...
        GlideUtils.loadRoundImage(mContext, item.getGameicon(), holder.mIvTransactionImage, R.mipmap.ic_placeholder);
...
//        holder.tv_play_count.setText(" • " + item.getPlay_count() + "人在玩");
        ...
        holder.tv_explain1.setText(item.getGoods_description());
        ...
        switch (item.getGoods_status()) {
            case 1: {
                ...
                holder.mTvBtnAction2.setOnClickListener(view -> {
                    ...
                    mHelper.stopSellingAction(item.getGid(), () -> refreshData());
                });
                ...
                gd1.setCornerRadius(60 * density);
                gd1.setStroke((int) (1 * density), ContextCompat.getColor(_mActivity, R.color.color_5571fe));
                holder.mTvBtnAction1.setBackground(gd1);
                holder.mTvBtnAction1.setTextColor(ContextCompat.getColor(_mActivity, R.color.color_5571fe));

                GradientDrawable gd2 = new GradientDrawable();
                gd2.setCornerRadius(60 * density);
                gd2.setStroke((int) (1 * density), ContextCompat.getColor(_mActivity, R.color.color_999999));
                holder.mTvBtnAction2.setBackground(gd2);
                holder.mTvBtnAction2.setTextColor(ContextCompat.getColor(_mActivity, R.color.color_999999));
                holder.mTvBtnAction1.setVisibility(View.GONE);
            }
            break;
            case 2: {
            ...
            case 4: {
                ...
                if (item.getIs_seller() != 1) {
                    ...
                    holder.mTvBtnAction1.setOnClickListener(view -> {
                        ...
                        if (_mFragment != null) {
                            _mFragment.startForResult(TransactionBuyFragment.newInstance(gid, item.getGamename(),item.getGame_suffix(), item.getGameicon(),
                                    item.getGenre_str(),item.getPlay_count(),
                                    item.getXh_showname(),item.getServer_info(),item.getProfit_rate(),
                                    good_price, gameid, game_type, 1, item.getGoods_type()), action_buy_good);
//                            _mFragment.startForResult(TransactionBuyFragment.newInstance(gid, good_pic, good_title,
//                                    gamename, good_price, gameid, game_type, 1), action_buy_good);
                        }
                    });
                    GradientDrawable gd1 = new GradientDrawable();
                    gd1.setCornerRadius(60 * density);
                    ...
                    GradientDrawable gd2 = new GradientDrawable();
                    gd2.setCornerRadius(60 * density);
                    gd2.setStroke((int) (1 * density), ContextCompat.getColor(_mActivity, R.color.color_d6d6d6));
                    holder.mTvBtnAction2.setBackground(gd2);
                    holder.mTvBtnAction2.setTextColor(ContextCompat.getColor(_mActivity, R.color.color_d6d6d6));
...
//                    }
            ...
            case 5: {
                ...
                holder.mTvBtnAction1.setVisibility(View.VISIBLE);
                holder.mTvBtnAction2.setVisibility(View.VISIBLE);
                holder.mTvBtnAction1.setText("说明");
                holder.mTvBtnAction2.setText("删除");
                holder.mTvBtnAction1.setOnClickListener(view -> {
                    //说明
            ...
            case 10: {
                ...
                String s = CommonUtils.formatTimeStamp(item.getShow_time() * 1000, regex);
                if (s.contains(yyyy)){
                    holder.mTvTransactionTime.setText(CommonUtils.formatTimeStamp(item.getShow_time() * 1000, "（MM-dd HH:mm）"));
                }else {
...
//                holder.mTvTransactionGoodStatus1.setVisibility(View.VISIBLE);
                holder.mTvTransactionGoodStatus.setTextColor(ContextCompat.getColor(_mActivity, R.color.color_232323));
//                holder.tv_explain.setVisibility(View.VISIBLE);
//                holder.tv_explain.setText(item.getFail_reason());
                holder.mTvTransactionGoodStatus.setOnClickListener(view -> {
                    _mFragment.start(new TransactionSpecificationFragment());
//                    _mFragment.showTransactionRule();
    ...
    public class ViewHolder extends AbsHolder {
        ...
        private TextView mTvTransactionGoodStatus1;
        ...
        public ViewHolder(View view) {
            ...
            mTvTransactionGoodStatus1 = findViewById(R.id.tv_transaction_good_status1);
            ...
            mTvTransactionXhRecharge.setTextColor(ContextCompat.getColor(mContext, R.color.color_5571fe));
        }
