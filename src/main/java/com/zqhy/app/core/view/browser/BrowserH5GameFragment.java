...
public class BrowserH5GameFragment extends BaseFragment {

    private JavaScriptInterface ajsi;

    public static BrowserH5GameFragment newInstance(String url) {
        BrowserH5GameFragment fragment = new BrowserH5GameFragment();
    ...
    public static BrowserH5GameFragment newInstance(String url,boolean showStatusBar) {
        BrowserH5GameFragment fragment = new BrowserH5GameFragment();
        Bundle bundle = new Bundle();
        bundle.putString("url", url);
        if (!showStatusBar){
    ...
    private void initWebView() {
        ...
        webSettings.setAllowContentAccess(true);// 允许访问ContentProvider资源
