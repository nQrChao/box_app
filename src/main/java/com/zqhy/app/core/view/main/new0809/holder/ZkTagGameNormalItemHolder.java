 ...
 * @description
 */
public class ZkTagGameNormalItemHolder extends BaseItemHolder<MainPageItemVo, ZkTagGameNormalItemHolder.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull MainPageItemVo item) {
        BaseRecyclerAdapter mPagerAdapter = new BaseRecyclerAdapter.Builder<>()
                .bind(GameInfoVo.class, new TagZkGameItemHolder(mContext, item.data.size()))
