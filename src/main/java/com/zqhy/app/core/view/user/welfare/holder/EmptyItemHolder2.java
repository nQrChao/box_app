...
public class EmptyItemHolder2 extends AbsItemHolder<EmptyDataVo1, EmptyItemHolder2.ViewHolder> {
    ...
    public EmptyItemHolder2(Context context) {
        super(context);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull EmptyDataVo1 item) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull EmptyItemHolder2.ViewHolder holder) {
