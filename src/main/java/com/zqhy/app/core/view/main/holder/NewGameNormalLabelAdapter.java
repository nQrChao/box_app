...
public class NewGameNormalLabelAdapter extends RecyclerView.Adapter<NewGameNormalLabelAdapter.LabelViewHolder> {

    private Context mContext;
    private List<Object> mItems; // 支持两种类型：String 或 GameLabelsBean

    public NewGameNormalLabelAdapter(Context context) {
        mContext = context;
    }
