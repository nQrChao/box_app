...
public class BrowserCloudActivity extends BaseActivity {
    ...
    public static void newInstance(Activity activity, String url, boolean isH5Game, String gamename, String gameid) {
        Intent intent = new Intent(activity, BrowserCloudActivity.class);
    ...
    /*private void confirmExitH5Game() {
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("是", (DialogInterface dialogInterface, int i) -> {
                    ...
                    exit();
                    *//*if (mWebView != null) {
                        //调用js中的函数：XCloudStop() 关闭云挂机
                        mWebView.loadUrl("javascript:XCloudStop()");
                    }*//*
                })
    ...
    private void confirmExitH5Game(){
        CustomDialog tipsDialog = new CustomDialog(this, LayoutInflater.from(this).inflate(R.layout.layout_dialog_cloud_exit, null), WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT, Gravity.BOTTOM);
