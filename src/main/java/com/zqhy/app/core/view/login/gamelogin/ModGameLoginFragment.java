...
import com.zqhy.app.core.view.login.RegisterFragment;
...
public class ModGameLoginFragment extends BaseFragment<ModGameLoginViewModel> implements View.OnClickListener {

    public static ModGameLoginFragment newInstance() {
        ModGameLoginFragment fragment = new ModGameLoginFragment();
    ...
    public int getLayoutResId() {
        return R.layout.mod_fragment_ts_login;
    }
    ...
    private void bindView() {
        ...
        mTvAutoLogin = findViewById(R.id.mod_tv_auto_login);
    ...
    private void saveUserInfo(String loginAccount, String password, UserInfoVo.DataBean dataBean) {
        ...
        if (!BuildConfig.GET_PERMISSIONS_FIRSR) {
            ...
            if (!hasShow) {
                ...
                Logs.e("saveUserInfo","A");
                Intent intent = new Intent();
                _mActivity.setResult(LOGIN_OK, intent);
                _mActivity.finish();
            }
        } else {
            Logs.e("saveUserInfo","C");
            Intent intent = new Intent();
            _mActivity.setResult(LOGIN_OK, intent);
            _mActivity.finish();
        }
