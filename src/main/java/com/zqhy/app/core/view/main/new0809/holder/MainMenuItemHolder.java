 ...
 * @description
 */
public class MainMenuItemHolder extends BaseItemHolder<MainMenuVo, MainMenuItemHolder.ViewHolder> {

    private int menuCount = 4;
    public MainMenuItemHolder(Context context, int menuCount) {
        super(context);
