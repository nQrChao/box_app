...
public class DetailTitleView {
    ...
    public DetailTitleView(Context context,BaseFragment mFragment,ForumDetailTitleVo item) {
   ...
   public View getView(){
    ...
    protected void onBindViewHolder( @NonNull ForumDetailTitleVo item) {
        ...
        tv_content.setOnImageClickListener(imageUrl -> {
            if (_mFragment != null) {
                //预览图片
                ...
                images.add(image);
                PreviewActivity.openActivity(_mFragment.getActivity(), images, true, 0, true, true);
            }
        });
    }
    ...
    public void createViewHolder() {
        view = LayoutInflater.from(mContext).inflate(R.layout.item_forum_detail_title,null,false);
