 ...
 * @description
 */
public class GameAppointmentTabItemHolder1 extends BaseItemHolder<GameAppointmentVo, GameAppointmentTabItemHolder1.ViewHolder> {

    public GameAppointmentTabItemHolder1(Context context) {
        super(context);
    }
    ...
    public int getLayoutResId() {
        return R.layout.item_game_appointment_tab1;
    }
