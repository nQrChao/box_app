 ...
 */
public class CommentDetailReplyHolder extends AbsItemHolder<CommentInfoVo.ReplyInfoVo, CommentDetailReplyHolder.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull CommentInfoVo.ReplyInfoVo item) {
        ...
        if (item.getMe_like() == 1) {
            holder.mTvReplyPraise.setTextColor(ContextCompat.getColor(mContext, R.color.color_ff8f19));
            ...
            holder.mTvReplyPraise.setTextColor(ContextCompat.getColor(mContext, R.color.color_999999));
