 ...
 * @description
 */
public class MainBannerItemView extends BaseItemHolder<BannerListVo, MainBannerItemView.ViewHolder> {
    ...
    public MainBannerItemView(Context context, int itemHeightDp) {
        super(context);
