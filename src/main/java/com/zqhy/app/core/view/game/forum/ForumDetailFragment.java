...
public class ForumDetailFragment extends BaseFragment<ForumViewModel> implements ForumReplyItemHolder.OnClickInterface {
    public static ForumDetailFragment newInstance(String tid) {
...
//                            replyList.addAll(data.getData());
    ...
    private void upDataUI(ForumDetailVo mInfo) {
        ...
        DetailTitle2View detailTitleView = new DetailTitle2View(_mActivity, this, forumDetailTitleVo);
        View view = detailTitleView.getView();
        detailTitleView.setClickable(new DetailTitle2View.Clickable() {
            @Override
...
//                            mAdapter.addAllData(data.getData());
    ...
    static String TAG = "XRecyclerViewDebug";
    @Override
