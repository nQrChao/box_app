...
public class CategoryDetailItemHolder extends AbsItemHolder<ForumCategoryVo.DataBean, CategoryDetailItemHolder.ViewHolder> {

    public CategoryDetailItemHolder(Context context) {
        super(context);
    }
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull ForumCategoryVo.DataBean item) {
        ...
        if (item.isClick()){
            ...
            holder.tv_content.setTextColor(Color.parseColor("#9B9B9B"));
            holder.tv_content.setBackgroundResource(R.drawable.shape_eaeaea_radius_line);
        }
    }

    @Override
    public int getLayoutResId() {
        return R.layout.item_forum_detail_category;
    }
