 ...
 */
public class ActValueItemHolder extends AbsItemHolder<ActValueListVo.DataBean, ActValueItemHolder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull ActValueListVo.DataBean item) {
