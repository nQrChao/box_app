...
public class ExpandTextView extends LinearLayout implements View.OnClickListener {
    ...
    //展开后显示的文字
    private CharSequence foldHint;
    //折叠起来后显示的文字
    private CharSequence expandHint;
    //标题文字颜色
    ...
    public void setFoldHint(CharSequence foldHint) {
    ...
    public void setExpandHint(CharSequence expandHint) {
    ...
    public void setIndicateImage(@SuppressLint("SupportAnnotationUsage") @DrawableRes Drawable indicateImage) {
    ...
    public int getMaxMeasureHeight() {
        ...
        int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(30000, View.MeasureSpec.AT_MOST);
    ...
    private void expand() {
        ...
        if (!flag) {
            ...
            if (mIndicateImage.getVisibility() == VISIBLE) {
