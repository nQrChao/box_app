...
import com.zqhy.app.widget.textbanner.utils.DisplayUtils;
...
public class TextBannerView extends RelativeLayout {
     ...
     * 设置字体类型：加粗、斜体、斜体加粗
     */
    private int mTypeface = TYPE_NORMAL;
    ...
    public void setHasSetDirection(boolean hasSetDirection) {
        this.hasSetDirection = hasSetDirection;
        setDirectionAnim();
    }
    ...
    public void setTypeface(int mTypeface) {
